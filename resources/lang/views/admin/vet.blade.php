...
<div class="row">
  ...
  <div class="text-end d-flex d-md-block ">
    <button class="bg_danger px-md-4 me-2 py-2 rounded-pill text-light" data-bs-toggle="offcanvas" data-bs-target="#edit_vet" aria-controls="edit_vet" type="button">
        Add A Vet
    </button>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="d-flex">
                    <button class="bg_danger text-light me-2"  data-bs-toggle="offcanvas" data-bs-target="#edit_vet" aria-controls="edit_vet" type="button"><i class="fas fa-pencil-alt"></i></button>
                    <button class="bg_danger text-light me-2" data-bs-toggle="offcanvas" data-bs-target="#view_vet" aria-controls="view_vet" type="button"><i class="fas fa-eye"></i></button>
                    <button class="bg_danger text-light me-2" data-bs-toggle="modal" data-bs-target="#exampleModal3" type="button"><i class="far fa-trash-alt"></i></button>
                </td>
              </tr>
                <td scope="row">1</td>
                <td>1</td>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="edit_vet" aria-labelledby="offcanvasRightLabel">
                    ...
                    <div class="offcanvas-body">
                      <form action="{{route('addvet')}}" method="post" >
                        @csrf
                        <div class="row pad-50 justify-content-around" id="edit_profile">
                            ...
                            <div class="col-12 col-md-3 text-center mt-5 pt-4 mt-md-0 pt-md-0 mb-5">
                              ...
                              <button type="file" name="profile" class="bg-transparent  profilebtn btnhover px-3 py-2" style="border-radius: 5px;">Upload Profile Picture</button>
                            ...
                            <div class="col-12 col-md-7">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <input type="text" class="form-control mb-4"  placeholder="Full Name" name="first_name">
                                        ...
                                        <div class="col-12 col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Registered Vetenary" name="reg_vet_council">

                                        </div>
                                        <!-- end of col  -->
                                        <div class="col-12 col-md-4 mb-3">

                                            <input type="text" class="form-control"  placeholder="VC Reg No" name="vc_reg_no">
                              ...
                              <div class="row">
                                ...
                                <div class="col-12 col-md-6 mb-3">
                                    <input type="text" class="form-control inputno1" placeholder="Contact Number" name="contact_no">

                                  </div>
                  
                                  <div class="col-12 col-md-6 mb-3">
                                    <input type="text" class="form-control inputno1" placeholder="Email Id"  name="email">

                                  </div>

                                  <div class="col-12 col-md-6 mb-3">
                                    <input type="password" class="form-control inputno1" placeholder="Password" name="password" >
                                  </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                  <input type="text" class="form-control" placeholder="Address First Line" aria-label="addressfirst" name="address_line1">
                                </div>
                                <div class="col-12 col-md-6 mt-3">
                                  <input type="text" class="form-control" placeholder="Address Second Line" aria-label="addresssecode" name="address_line2">
                                </div>
                                <div class="col-12 col-md-6 mt-3">
                                  <input type="text" class="form-control" placeholder="Enter Area" aria-label="area" name="area">
                                </div>
                                <div class="col-12 col-md-6 mt-3">
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                  <select id="inputTaluka" class="form-select overflow-scroll " name="taluke">
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                  <input type="text" class="form-control" placeholder="Pin Code" aria-label="pincode" name="pincode">
                                </div>
                  ...
                  <!-- vet tab  edit off anvas  -->
                  <div class="offcanvas offcanvas-end" tabindex="-1" id="view_vet" aria-labelledby="offcanvasRightLabel">
                    <div class="offcanvas-header">
                      <h5 id="offcanvasRightLabel">
