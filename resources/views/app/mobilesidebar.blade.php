<div class="d-md-flex align-items-start bg-light" id="tab_pill_main">
                        ...
                        @if(Auth::check()=='true')
                            ...
                            <a  href="{{url('trans/profile')}}"class="nav-link btn-p px-5 border-bottom px-md-1 ps-xl-3 text-light py-3 text-start" id="v-pills-settings6-tab"  role="tab" > <i class="fas fas fa-tasks me-3 me-lg-1 me-xl-3"></i>Profile</a>
                            @endif
                @else
