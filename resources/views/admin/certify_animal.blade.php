                ...
                <tr>
                  ...
                  <td class="d-flex">
                    <button class="bg_danger text-light me-2" data-bs-toggle="offcanvas"
                      data-bs-target="#edit_certified" aria-controls="edit_certified" type="button"><i
                        class="fas fa-pencil-alt"></i></button>
                    <button class="bg_danger text-light me-2" data-bs-toggle="offcanvas"
                      data-bs-target="#view_certified{{$certify->user_id}}" aria-controls="view_certified" type="button"><i
                            ...
                            <div class="modal-foote d-flex">
                              <a href="#" class="text-decoration-none col-6"><button type="button" class="btn border form-control btnhover"
                                  data-bs-dismiss="modal">No</button></a>
                                    ...
                                    @csrf
                                    <input type="hidden" value="{{$certify->id}}" name="user_id">
                  ...
                  <td>
                    ...
                    <!-- certified tab  view off anvas  -->
                                <div class="offcanvas offcanvas-end" tabindex="-1" id="view_certified{{$certify->user_id}}" aria-labelledby="offcanvasRightLabel" style="width: 70%;">
                                        ...
                                        <form action="" method="post">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-4 col-lg-3 my-3">
                                              ...
                                              <select id="animaltype" class="form-select" onchange="showDiv('hidden_div', this)" name="animaltype">
                                                ...
                                                <option value="{{$certify->animal_type}}" disabled selected>{{$certify->animal_type}}</option>
                                                @else
                                            ...
                                            <div class="col-md-4 col-lg-3 my-3">
                                              ...
                                              <input type="text" name="animalsno" id="" value="{{$certify->no_of_animal}}" class="form-control" placeholder="No Of Animals ">
                                            ...
                                            <div class="col-md-4 col-lg-3 my-3">
                                              ...
                                              <input type="text" name="personname" id="" class="form-control" value="{{$certify->contact_name}}" placeholder="Contact Person Name ">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-4 col-lg-3 my-3">
                                              ...
                                              <input type="text" name="mobileno" id="" value="{{$certify->contact_no}}" class="form-control" placeholder="Contact Number">

                                            </div>

                                            <div class="col-md-4 col-lg-3 my-3">

                                              <input type="text" name="address1" id="" class="form-control" value="{{$certify->address_line1}}" placeholder="Address Line 1 ">
                                            ...
                                            <div class="col-md-4 col-lg-3 my-3">
                                              ...
                                              <input type="text" name="address2" id="" class="form-control" value="{{$certify->address_line2}}" placeholder="Address Line 2">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-4 col-lg-3 my-3">
                                              ...
                                              <input type="text" name="pincode" id="" value="{{$certify->zipcode}}" class="form-control" placeholder="Pin Code" disabled>
                                            ...
                                            <div class="col-md-4 col-lg-3 my-3">
                                              ...
                                              <input type="text" name="pincode" id="" value="{{$certify->appointment_date}}" class="form-control" placeholder="Appointment Date" disabled>
                                            ...
                                            <div class="col-md-4 col-lg-3 my-3">
                                              ...
                                              <input type="text" name="vetcontact" id=""  value="{{$certify->appointment_time}}" class="form-control" placeholder="Appointment Time" disabled>
                                          ...
                                          <div class="row justify-content-around mt-3 text-center">
                                            ...
                                            <div class="col-12 col-md-6 text-start pb-5">
                                              ...
                                              <br>
                                              <textarea name="comment" placeholder="   Comments" class="comment form-control" id="" rows="5" disabled>{{$certify->comment}}</textarea>
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-12 col-md-4 mt-3">
                                                ...
                                                <textarea name="comment" placeholder="   Comments By Vet..." class="comment form-control" id=""
                                                  rows="5"></textarea>
