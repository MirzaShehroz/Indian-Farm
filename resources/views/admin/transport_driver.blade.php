    ...
    <div class="col-12 mt-4">
      ...
      <div class="text-end d-flex d-md-block ">
        <button class="bg_danger px-md-4 me-2 py-2 rounded-pill text-light" data-bs-toggle="offcanvas"
          data-bs-target="#edit_transport" aria-controls="edit_transport" type="button">
          Add A Transport
        </button>
          ...
          <tbody>
            @foreach($data as $item)
              <tr>
                ...
                <td class="d-flex">
                  <button class="bg_danger text-light me-2" data-bs-toggle="offcanvas" data-bs-target="#edit_transport{{$item->user_id}}"
                    aria-controls="edit_transport" type="button"><i class="fas fa-pencil-alt"></i></button>
                  <button class="bg_danger text-light me-2" data-bs-toggle="offcanvas" data-bs-target="#view_transport"
              ...
              {{-- edit model --}}
              <div class="offcanvas offcanvas-end" tabindex="-1" id="edit_transport{{$item->user_id}}" aria-labelledby="offcanvasRightLabel" style="width:70%;">
                ...
                <div class="offcanvas-body">
                  ...
                  <form action="{{ route('update_transport') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row pad-50 justify-content-around" id="edit_profile">
                      ...
                      <div class="col-12 col-md-3 text-center mt-5 pt-4 mt-md-0 pt-md-0 mb-5">
                        ...
                        <h4 class="border-start border-5 tcolor" style="border-color: #0572B2 !important;">Edit A Transport</h4>
                      ...
                      <div class="col-12 col-md-7">
                          ...
                          <div class="col-12">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 col-md-4">
                                ...
                                <input type="text" class="form-control mb-4" name="first_name" value="{{$item->first_name}}" placeholder="First Name" required>
                              ...
                              <div class="col-12 col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="middle_name" value="{{$item->middle_name}}" placeholder="Middle Name">
                              ...
                              <div class="col-12 col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="last_name" value="{{$item->last_name}}" placeholder="Last Name">
              
                              </div>
                              <!-- end of col  -->
                              <div class="col-12 col-md-4 mb-3">
              
                                <input type="text" class="form-control" name="license_no" value="{{$item->license_no}}" placeholder="License No" required>
              
                              </div>
                              <!-- end of col  -->
                              <div class="col-12 col-md-4 mb-3">
              
                                <input type="text" class="form-control" name="make" value="{{$item->vehicle_make_model}}" placeholder="Vehicle model and make" required>
              
                              </div>
                              <!-- end of col  -->
                              <div class="col-12 col-md-4 mb-3">
              
                                <input type="text" class="form-control" name="type" value="{{$item->vehicle_type}}" placeholder="Vehicle type" required>
                          ...
                          <div class="col-12 col-lg-10 ">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 col-md-6 mb-3">
                                <input type="text" class="form-control inputno1" name="contact_no" value="{{$item->contact_no}}" placeholder="Contact Number"
                                  required>
              
                              </div>
              
                              <div class="col-12 col-md-6 mb-3">
                                <input type="text" class="form-control inputno1" name="email" value="{{$item->email}}" placeholder="Email Id" required>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-6 mt-3">
                            <input type="text" class="form-control" placeholder="Address First Line" value="{{$item->address_line1}}" name="address_line1"
                              aria-label="addressfirst" required>
                          </div>
                          <div class="col-12 col-md-6 mt-3">
                            <input type="text" class="form-control" placeholder="Address Second Line" value="{{$item->address_line2}}" name="address_line2"
                              aria-label="addresssecode">
                          </div>
                          <div class="col-12 col-md-6 mt-3">
                            <input type="text" class="form-control" placeholder="Enter Area" name="area" value="{{$item->area}}" aria-label="area" required>
                          </div>
                          <div class="col-12 col-md-6 mt-3">
                          ...
                          <div class="col-12 col-md-6 mt-3">
                            <input type="text" class="form-control" name="zipcode" placeholder="Pin Code" value="{{$item->zipcode}}" aria-label="pincode"
                              required>
                          </div>
              ...
              <!-- transport tab  view off anvas  -->
              <div class="offcanvas offcanvas-end" tabindex="-1" id="view_transport" aria-labelledby="offcanvasRightLabel">
                <div class="offcanvas-header">
                  <h5 id="offcanvasRightLabel">
                ...
                <div class="offcanvas-body">
                  ...
                  <div class="row pad-50 justify-content-around" id="edit_profile">
                    ...
                    <div class="col-12 col-md-3 text-center mt-5 pt-4 mt-md-0 pt-md-0 mb-5">
                      ...
                      <h4 class="border-start border-5 tcolor" style="border-color: #0572B2 !important;">View A Transport</h4>
                      ...
                      <div class="row mt-5">
                        ...
                        <div class="col-12">
                          ...
                          <h5 class="mb-4"> Upload Documents</h5>
                          <input type="file" name="" class="form-control d-block mt-3" id="">
                          <input type="file" name="" class="form-control d-block mt-3" id="">
                          <input type="file" name="" class="form-control d-block mt-3" id="">
                          ...
                          <div class="col-12">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Registered Vetenary">

                              </div>
                              <!-- end of col  -->
                              <div class="col-12 col-md-4 mb-3">

                                <input type="text" class="form-control" placeholder="VC Reg No">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-lg-10 ">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 col-md-6 mb-3">
                                <input type="text" class="form-control inputno1" placeholder="Contact Number">

                              </div>

                              <div class="col-12 col-md-6 mb-3">
                                <input type="text" class="form-control inputno1" placeholder="Email Id">

                              </div>

                              <div class="col-12 col-md-6 mb-3">
                                <input type="text" class="form-control inputno1" placeholder="Password">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="edit_transport" aria-labelledby="offcanvasRightLabel">
  <div class="offcanvas-header">
    <h5 id="offcanvasRightLabel">
