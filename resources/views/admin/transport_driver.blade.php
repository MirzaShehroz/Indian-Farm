...
<div class="row">
  ...
  <div class="text-end d-flex d-md-block ">
    <button class="bg_danger px-md-4 me-2 py-2 rounded-pill text-light" data-bs-toggle="offcanvas" data-bs-target="#edit_transport" aria-controls="edit_transport" type="button">
        Add A Transport
    </button>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td class="d-flex">
                    <button class="bg_danger text-light me-2"  data-bs-toggle="offcanvas" data-bs-target="#edit_transport" aria-controls="edit_transport" type="button"><i class="fas fa-pencil-alt"></i></button>
                    <button class="bg_danger text-light me-2" data-bs-toggle="offcanvas" data-bs-target="#view_transport" aria-controls="view_transport" type="button"><i class="fas fa-eye"></i></button>
                    <button class="bg_danger text-light me-2" data-bs-toggle="modal" data-bs-target="#exampleModal4" type="button"><i class="far fa-trash-alt"></i></button>
                </td>
              </tr>
