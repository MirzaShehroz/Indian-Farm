 ...
 @csrf   
    <div class="row pad-50 justify-content-around mt-5 pt-5 mt-lg-0" id="post_ad">
        ...
        <div class="col-12 col-md-6 col-lg-3 pt-3  shadow">
            ...
            <div class="mb-2">
                <input type="date" class="form-control" name="month_due" id="monthpregnent" placeholder="Due Month If Pregnant" required>
            </div>
            <div class="mb-2">
        ...
        <div class="col-12 col-md-6 col-lg-3 mt-4 mt-lg-0  shadow">
            ...
            <div class="d-flex justify-content-aroun mt-3">
                ...
                <div class="form-check ">
                    <input class="form-check-input" type="radio" name="status" value="female" id="flexRadioDefault1" >
                    <label class="form-check-label" for="flexRadioDefault1">
                        Female
                    </label>
                </div>
                <div class="form-check ms-4">
                    <input class="form-check-input" type="radio" name="status" value="male" id="flexRadioDefault2" checked>
            ...
            <div class="d-flex justify-content-around mt-3">
                ...
                <div class="form-check ms-4">
                    <input class="form-check-input" type="radio" name="pregnant" value="0" id="Pregnant2" checked>
        ...
        @enderror
            ...
            <div class="d-flex justify-content-around mt-3 mb-4">
                ...
                @error('vacinated')
                    <span>Vacination status is required</span>
                @enderror
            </div>
