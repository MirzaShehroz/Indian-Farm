            ...
            <div class="col-12 col-md-10">
                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-6 col-md-2 text-center ">
                        ...
                        <img src="https://images.pexels.com/photos/8432736/pexels-photo-8432736.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="your_ad_img" alt="img not found">
                    ...
                    <div class="col-6 col-md-2  border-start border-dark">
                        ...
                        <strong><span><i class="fas fa-rupee-sign me-2"></i></span> <span>700.00</span> </strong>

                    </div>
                    <!-- end of col  -->

                    <div class="col-6 mt-4 mt-md-0 col-md-2  border-start border-dark">
                        <h6 class="mb-3 tcolor fw-bold">Quantity =<span class="ms-2 text-dark">01</span> </h6>
                    ...
                    <div class="col-12 col-md-2 mt-4 mt-md-0 border-start border-dark ">
                        ...
                        <div class="d-flex d-md-block d-lg-flex justify-content-around">
                            ...
                            <button type="button" class="btnhover px-3 px-md-2 px-lg-2 px-xl-3 border border-secondary bg-transparent rounded-pill">Remove</button>
