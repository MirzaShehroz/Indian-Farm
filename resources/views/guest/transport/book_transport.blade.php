...
<div class="row pad-50 mt-5 pt-5 pt-lg-0 justify-content-around">
    ...
    <h4 class="mt-5 pt-5 mb-4 mt-md-0">{{__('eng.bookTrans')}}</h4>
    ...
    <div class="row">
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <select id="animaltype"  class="form-select" onchange="showDiv('hidden_div', this)" name="animaltype" value="{{old('animaltype')}}">
                  <option name="animal_type" value="" disabled  selected>{{__('eng.animalType')}}</option>
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="number" name="animalsno" value="{{old('animalsno')}}" id="" class="form-control" placeholder="{{__('eng.noAnimal')}} ">
                @error('animalsno')
                {{$message}}
            @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="text" name="personname" id="" value="{{old('personname')}}" class="form-control" placeholder="{{__('eng.personName')}} ">
                @error('personname')
                {{$message}}
                 @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="tel" name="mobileno" id="" value="{{old('mobileno')}}" class="form-control" placeholder="{{__('eng.contactNum')}} ">
                @error('mobileno')
                {{$message}}
            @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="date" name="dot" id="" value="{{old('dot')}}" class="form-control" placeholder="{{__('eng.transDate')}}">
                @error('dot')
                {{$message}}
            @enderror
              </div>
    ...
    <div class="row">
        ...
        <h5 class="tcolor my-4">{{__('eng.fromAddress')}}</h5>
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="text" name="faddressline1" id="" value="{{old('faddressline1')}}" class="form-control" placeholder="{{__('eng.address1')}} ">
                @error('faddressline1')
                {{$message}}
            @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="text" name="faddressline2" id="" value="{{old('faddressline2')}}" class="form-control" placeholder="{{__('eng.address2')}}">
                @error('faddressline2')
                {{$message}}
            @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="text" name="fromarea" value="{{old('fromarea')}}" id="" class="form-control" placeholder="{{__('eng.area')}} ">
                @error('fromarea')
                {{$message}}
            @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <div class="Districdropdown">
                    <select id="inputDistrict" name="fromcity" value="{{old('fromcity')}}" class="form-select overflow-scroll  ">
                      <option value="" selected>{{__('eng.city')}}</option>
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="number" name="frompincode" id="" value="{{old('frompincode')}}" class="form-control" placeholder="{{__('eng.pinCode')}} ">
                @error('frompincode')
                {{$message}}
                 @enderror
    ...
    <div class="row mb-4">
        ...
        <h5 class="tcolor my-4">{{__('eng.toAddress')}}</h5>
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="text" name="taddressline1" id="" value="{{old('taddressline1')}}" class="form-control" placeholder="{{__('eng.address1')}} ">
                @error('taddressline1')
                {{$message}}
            @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="text" name="taddressline2" id="" value="{{old('taddressline2')}}" class="form-control" placeholder="{{__('eng.address2')}}">
                @error('taddressline2')
                {{$message}}
            @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="text" name="toarea" id="" value="{{old('toarea')}}" class="form-control" placeholder="{{__('eng.area')}} ">
                @error('toarea')
                {{$message}}
            @enderror
            ...
            <div class="col-md-4 col-lg-3 my-3">
                ...
                <input type="number" name="topincode" id="" value="{{old('topincode')}}" class="form-control" placeholder="{{__('eng.pinCode')}} ">
                @error('topincode')
                {{$message}}
                 @enderror
