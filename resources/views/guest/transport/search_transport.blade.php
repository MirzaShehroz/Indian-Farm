        ...
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    <a class="navbar-brand me-lg-5" href="user-login.html"><img
                            src="../../public/images/India-Farm-Logo.png" alt="img not found"
                            class="brand-logo w-100"></a>

                    <div class="dropdown d-lg-none">
                        <button class="btn bg-transparent dropdown-toggle" type="button" id="dropdownMenuButton1"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="../../public/images/admin.jpg" style="width: 30px; height: 30px;"
                                alt="img not found">
                        </button>
                        <ul class="dropdown-menu"
                            style=" border-top: 3px solid #0572B2; border-bottom: 3px solid #0572B2;"
                                ...
                                <a class="dropdown-item" href="#">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="../../public/images/user-img.png"
                                                style="width: 40px; height: 40px;" alt="img not found">
                                        </div>
                            ...
                            <li class="my-3"><a class="dropdown-item border-bottom" href="edit_profile.html"><i
                                        class="fas fa-user-edit me-3"></i>Edit Your Profile</a></li>
                            <li class="my-3"><a class="dropdown-item border-bottom" href="your_ad.html"><i
                                        class="fas fa-ad me-3"></i>Your Ads</a></li>
                            <li class="my-3"><a class="dropdown-item border-bottom" href="post_ad.html"><i
                                        class="fas fa-address-card me-3"></i>Post an Ad</a></li>
                            <li class="my-3"><a class="dropdown-item border-bottom" href="your_subscription.html"><i
                                        class="fas fa-vote-yea me-3"></i>Your Subscription </a></li>
                            <li class="my-3"><a class="dropdown-item" href="index.html"><i
                            ...
                            <ul class="list-unstyled mb-lg-0 align-items-center">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu w-100" aria-labelledby="navbarDropdown">
                                        ...
                                        <li><a class="dropdown-item border-bottom" href="search_vet.html">Search Vet</a>
                                        </li>
                                        <!-- <li><a class="dropdown-item" href="consultation.html">Consultation</a></li> -->
                                        <li><a class="dropdown-item border-bottom" href="book_appointment.html">Book An
                                                Appointment</a></li>
                                        <li><a class="dropdown-item border-bottom" href="certify_animal.html">Certify My
                                                Animal</a></li>
                                        <li><a class="dropdown-item" href="vet_ragistration.html">Vet Registration</a>
                                        </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu w-100" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item border-bottom" href="search_transport.html">Search
                                                Transport</a></li>
                                        <li><a class="dropdown-item border-bottom" href="book_transport.html"> Book Your
                                                Transport</a></li>
                                        <li><a class="dropdown-item" href="register_vendor.html">Register As Vendor</a>
                                        </li>
                    ...
                    <div class="collapse navbar-collapse pe-lg-4" id="navbarSupportedContent">
                            ...
                            <form class="d-flex">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text btn bg-transparent rounded-pill "
                                        style="z-index: 1200;" id="basic-addon2"><i class="fas fa-search"></i></span>
                                </div>
                            </form>
                        ...
                        <div class="btn1 d-flex align-items-center justify-content-around mt-4 mt-lg-0 ms-xl-5">
                            ...
                            <div class="dropdown dropstart">
                                ...
                                <ul class="dropdown-menu p-1 mt-5"
                                    style=" border-top: 3px solid #0572B2; border-bottom: 3px solid #0572B2;"
                                    aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li class="my-3"><a class="dropdown-item border-bottom" href="post_ad.html"><i
                                                class="fas fa-address-card me-3"></i>Post an Ad</a></li>
                                    <li class="my-3"><a class="dropdown-item border-bottom"
                                            href="your_subscription.html"><i class="fas fa-vote-yea me-3"></i>Your
                                            Subscription </a></li>
                                    <li class="my-3"><a class="dropdown-item" href="index.html"><i
                                                class="fas fa-sign-out-alt me-3"></i>Log Out</a></li>
                                </ul>
