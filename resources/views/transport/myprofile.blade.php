...
<div class="row pad-50 justify-content-between" id="edit_profile">
    ...
    <div class="col-12 col-md-3 text-center mt-5 pt-4 mt-md-0 pt-md-0 mb-5">
      ...
      <h4 class="border-start border-5 tcolor" style="border-color: #0572B2 !important;">{{__('eng.yourInput')}}</h4>
      @if(Auth::check()=='true')
      ...
      <form action="{{url('update/trasport/profile')}}" method="post" enctype="multipart/form-data">
        @csrf
...
@endif       
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 mb-3">
            ...
            <input type="text" class="form-control" name="vehicle_type" value="{{$user->vehicle_type}}"  placeholder="{{__('eng.displayAnimalType')}}"  required>
        ...
        <div class="col-12 col-md-6 mb-3">
            ...
            <input type="text" class="form-control" name="make_model" value="{{$user->vehicle_make_model}}"  placeholder="{{__('eng.vehicleMake')}}"  required>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body text-center p-4">
          ...
          <div>
              <form action="{{url('transport/change/passowrd')}}" method="post" id="changepassword" >
                @csrf
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center p-4">
          ...
          <form method="post">
             ...
             <button id="changeemail" onclick="changeTransportEmail({{Auth::user()->id}})" type="button" class="py-3 form-control mt-5 bg_danger text-light" data-bs-toggle="modal" data-bs-target="#otpnumber">{{__('eng.submit')}}</button>
         </form>
          </div>
        </div>
