...
@endif       
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 mb-3">
            ...
            <input type="text" class="form-control" name="vehicle_type" value="{{$user->vehicle_type}}"  placeholder="Vehicle Type"  required>
        ...
        <div class="col-12 col-md-6 mb-3">
            ...
            <input type="text" class="form-control" name="make_model" value="{{$user->vehicle_make_model}}"  placeholder="Vehicle Make Model"  required>
